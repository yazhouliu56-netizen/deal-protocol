...
export default function FloatingSosButton({ waveId }: { waveId?: string }) {
  ...
  return (
    <motion.button
      ...
      className="fixed left-4 bottom-28 z-40 flex h-12 w-12 items-center justify-center rounded-full bg-[#ff4b4b] border-b-4 border-[#d63030] text-white text-xs font-black shadow-lg active:translate-y-0.5 active:border-b-2 transition-[transform]"
    >
      SOS
    </motion.button>
  );
