  ...
  return (
    <AnimatePresence>
      {draft && (
        ...
        >
          <div className="relative rounded-3xl bg-white border border-[var(--color-duo-swan)] shadow-sm p-4">
            ...
            />
            <p className="text-xs text-[var(--color-duo-hare)] mt-3 text-center">
