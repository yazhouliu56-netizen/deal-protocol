      ...
      <div className="flex-1 min-h-0 w-full flex items-center justify-center relative">
        {mode === "scene" ? (
          <div className="absolute inset-0 pointer-events-none">
            ...
            <div className="absolute inset-x-6 top-4 bottom-6 rounded-2xl border-2 border-[var(--color-duo-swan)] pointer-events-none"><span className="absolute -top-[7px] left-3 px-1 text-xs tracking-[0.3em] text-white bg-black/30 rounded">AR 取景框</span></div>
