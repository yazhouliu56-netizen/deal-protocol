...
export default function PwaServiceWorker() {
  ...
  return (
    <button
      ...
      className="fixed top-3 left-1/2 -translate-x-1/2 z-[70] bg-white border-2 border-[var(--color-duo-swan)] border-b-4 rounded-full px-4 py-2 text-xs font-bold text-[var(--color-duo-blue-ink)] animate-pulse"
      aria-label="刷新以使用新版本"
    >
      ✨ 已更新，点击刷新使用新版本
    </button>
