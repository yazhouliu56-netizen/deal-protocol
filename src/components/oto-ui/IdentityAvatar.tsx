...
export default function IdentityAvatar({
  ...
  return (
    <div
      className={`${cls} bg-[var(--color-duo-polar)] border border-[var(--color-duo-swan)] text-[var(--color-duo-eel)] flex items-center justify-center overflow-hidden font-extrabold shadow-sm shrink-0`}
    >
      {avatar ? (
