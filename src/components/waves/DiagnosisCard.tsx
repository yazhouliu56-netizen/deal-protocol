    ...
    >
      ...
      {advice.map((a, i) => (
        <div
          ...
          className="rounded-xl bg-white border-2 border-[var(--color-duo-swan)] px-2.5 py-2"
        >
          <p className="text-xs font-bold text-[var(--color-duo-eel)] flex items-start gap-1.5">
