...
> 新增发现一律追加此表；项目按宪法 §1「先定位六圈再立项」逐项排期。
>
> **✅ §5 缺口已全部关闭（2026-08-13）**：N1-N16 十六项已逐项落地
> （ADR-0008/0009/0010/0011/0012/0013/0014/0015），单测 332 → 365 全绿。
> 后续新缺口按同流程追加。

| # | 缺口 | 所属圈 | 来源 |
|---|------|--------|------|
| N1 | ~~虚拟号/隐私号中枢（双向）~~ | ② | ~~0006 映射~~ ✅ **已关闭（2026-08-13，ADR-0010）** |
| N2 | ~~动态表单渲染引擎通用化（web 侧反哺自 mobile DynamicForm）~~ | ① | ~~0006 + Phase 4 新增~~ ✅ **已关闭（2026-08-13，ADR-0015）** |
| N3 | ~~语义向量匹配推荐~~ | ③ | ~~0006 映射~~ ✅ **已关闭（2026-08-13，ADR-0011）** |
| N4 | ~~AIGC 伪造鉴真~~ | ③ | ~~0006 映射~~ ✅ **已关闭（2026-08-13，ADR-0012）** |
| N5 | ~~智能争议小法官（LLM 定责）~~ | ③ | ~~0006 映射~~ ✅ **已关闭（2026-08-13，ADR-0008）** |
| N6 | ~~自然语言 BI~~ | ③ | ~~0006 映射~~ ✅ **已关闭（2026-08-13，ADR-0011）** |
| N7 | ~~电子签章 / 保险对接~~ | ④ | ~~0006 映射~~ ✅ **已关闭（2026-08-13，ADR-0012）** |
| N8 | ~~极端危机干预协议（web 侧；SOS 壳在 mobile）~~ | ⑤ | ~~0006 映射~~ ✅ **已关闭（2026-08-13，ADR-0013）** |
| N9 | ~~多因子反欺诈探针（设备指纹/GPS 欺骗）~~ | ⑤ | ~~0006 映射~~ ✅ **已关闭（2026-08-13，ADR-0009）** |
| N10 | ~~数据全生命周期脱敏 / 遗忘权统一~~ | ⑤ | ~~0006 映射~~ ✅ **已关闭（2026-08-13，ADR-0013）** |
| N11 | ~~弱网离线队列~~ | ⑥ | ~~0006 映射~~ ✅ **已关闭（2026-08-13，ADR-0014）** |
| N12 | ~~智能运力熔断 / 供需杠杆~~ | ⑥ | ~~0006 映射~~ ✅ **已关闭（2026-08-13，ADR-0014）** |
| N13 | ~~多云多活 / 优雅降级四部曲~~ | ⑥ | ~~0006 映射~~ ✅ **已关闭（2026-08-13，ADR-0014）** |
| N14 | ~~数据湖 / AB 平台 / 哈希存证~~ | ⑥ | ~~0006 映射~~ ✅ **已关闭（2026-08-13，ADR-0014）** |
| N15 | ~~IM 中枢独立立项（chat/ 归位设计，含隐私号联动）~~ | ② | ~~§1.3 映射修正~~ ✅ **已关闭（2026-08-13，ADR-0010）** |
| N16 | ~~base/geo 的 RN 适配层（mobile location.ts 接入）~~ | ① | ~~Phase 4~~ ✅ **已关闭（2026-08-13，ADR-0015）** |
